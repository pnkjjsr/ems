...
export function show(req, res) {
  return Year.findById(req.params.id).exec()
...
export function upsert(req, res) {
  ...
  return Year.findOneAndUpdate({_id: req.params.id}, req.body, {new: true, upsert: true, setDefaultsOnInsert: true, runValidators: true}).exec()
